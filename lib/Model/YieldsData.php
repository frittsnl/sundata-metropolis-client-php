 ...
 */
class YieldsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Yields_data';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('yield_in_wh', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets time
     *
     * @param string|null $time uses RFC-3339 notation
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getYieldInWh()
    {
        return $this->container['yield_in_wh'];
    }

    /**
     * Sets yield_in_wh
     *
     * @param int|null $yield_in_wh yield_in_wh
     *
     * @return self
     */
    public function setYieldInWh($yield_in_wh)
    {
        if (is_null($yield_in_wh)) {
            throw new \InvalidArgumentException('non-nullable yield_in_wh cannot be null');
        }
        $this->container['yield_in_wh'] = $yield_in_wh;
