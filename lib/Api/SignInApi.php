...
class SignInApi
{
     ...
     */
    public function signIn($request = null)
    {
     ...
     */
    public function signInWithHttpInfo($request = null)
    {
     ...
     */
    public function signInAsync($request = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function signInAsyncWithHttpInfo($request = null)
    {
        $returnType = '\SunDataMetropolisClient\Model\Response';
        $request = $this->signInRequest($request);
     ...
     */
    public function signInRequest($request = null)
    {
