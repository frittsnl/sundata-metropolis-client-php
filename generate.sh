...
openapi-generator generate -i ../metropolis/gen/openapi.yaml -g php --additional-properties=invokerPackage=SunDataMetropolisClient --git-user-id frittsnl --git-repo-id sundata-metropolis-client-php
