...
/**
 * CreateMeterPayloadRefId Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  SunDataMetropolisClient
 ...
 */
class CreateMeterPayloadRefId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateMeterPayloadRefId';
    ...
    */
    ...
    public function setOrientationInDegrees($orientation_in_degrees)
    {
        ...
        if (!is_null($orientation_in_degrees) && ($orientation_in_degrees > 359)) {
            throw new \InvalidArgumentException('invalid value for $orientation_in_degrees when calling CreateMeterPayloadRefId., must be smaller than or equal to 359.');
        }
        if (!is_null($orientation_in_degrees) && ($orientation_in_degrees < 0)) {
            throw new \InvalidArgumentException('invalid value for $orientation_in_degrees when calling CreateMeterPayloadRefId., must be bigger than or equal to 0.');
        }
    ...
    public function setAngleInDegrees($angle_in_degrees)
    {
        ...
        if (!is_null($angle_in_degrees) && ($angle_in_degrees > 359)) {
            throw new \InvalidArgumentException('invalid value for $angle_in_degrees when calling CreateMeterPayloadRefId., must be smaller than or equal to 359.');
        }
        if (!is_null($angle_in_degrees) && ($angle_in_degrees < 0)) {
            throw new \InvalidArgumentException('invalid value for $angle_in_degrees when calling CreateMeterPayloadRefId., must be bigger than or equal to 0.');
        }
