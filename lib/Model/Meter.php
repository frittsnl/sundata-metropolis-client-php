 ...
 */
class Meter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'id' => false,
		'plant_id' => false,
		'inbound_driver_id' => false,
		'reference_identifier' => false,
		'amount_in_cents_per_kwh' => false,
		'peak_in_watt' => false,
		'p90_in_kwh' => false,
		'orientation_in_degrees' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('inbound_driver_id', $data ?? [], null);
        ...
        $this->setIfExists('operational_since', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($inbound_driver_id)) {
            throw new \InvalidArgumentException('non-nullable inbound_driver_id cannot be null');
        }
    ...
    public function setAmountInCentsPerKwh($amount_in_cents_per_kwh)
    {
        if (is_null($amount_in_cents_per_kwh)) {
            throw new \InvalidArgumentException('non-nullable amount_in_cents_per_kwh cannot be null');
        }
    ...
    public function setPeakInWatt($peak_in_watt)
    {
        if (is_null($peak_in_watt)) {
            throw new \InvalidArgumentException('non-nullable peak_in_watt cannot be null');
        }
    ...
    public function setP90InKwh($p90_in_kwh)
    {
        if (is_null($p90_in_kwh)) {
            throw new \InvalidArgumentException('non-nullable p90_in_kwh cannot be null');
        }
    ...
    public function setOrientationInDegrees($orientation_in_degrees)
    {
        if (is_null($orientation_in_degrees)) {
            throw new \InvalidArgumentException('non-nullable orientation_in_degrees cannot be null');
        }

        if (($orientation_in_degrees > 359)) {
    ...
    public function setAngleInDegrees($angle_in_degrees)
    {
        if (is_null($angle_in_degrees)) {
            throw new \InvalidArgumentException('non-nullable angle_in_degrees cannot be null');
        }
    ...
    public function setRetiredOn($retired_on)
    {
        if (is_null($retired_on)) {
            throw new \InvalidArgumentException('non-nullable retired_on cannot be null');
        }
    ...
    {
        if (is_null($operational_since)) {
            throw new \InvalidArgumentException('non-nullable operational_since cannot be null');
        }
