...
class PlantsApi
{
     ...
     * @return string[]
     */
    public function attachTag($company_id, $plant_id, $tag_id)
    {
        list($response) = $this->attachTagWithHttpInfo($company_id, $plant_id, $tag_id);
        return $response;
    }
     ...
     * @return array of string[], HTTP status code, HTTP response headers (array of strings)
     */
    public function attachTagWithHttpInfo($company_id, $plant_id, $tag_id)
    {
        $request = $this->attachTagRequest($company_id, $plant_id, $tag_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attachTagAsync($company_id, $plant_id, $tag_id)
    {
        return $this->attachTagAsyncWithHttpInfo($company_id, $plant_id, $tag_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attachTagAsyncWithHttpInfo($company_id, $plant_id, $tag_id)
    {
        $returnType = 'string[]';
        $request = $this->attachTagRequest($company_id, $plant_id, $tag_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function attachTagRequest($company_id, $plant_id, $tag_id)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return string[]
     */
    public function detachTag($company_id, $plant_id, $tag_id)
    {
        list($response) = $this->detachTagWithHttpInfo($company_id, $plant_id, $tag_id);
        return $response;
    }
     ...
     * @return array of string[], HTTP status code, HTTP response headers (array of strings)
     */
    public function detachTagWithHttpInfo($company_id, $plant_id, $tag_id)
    {
        $request = $this->detachTagRequest($company_id, $plant_id, $tag_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function detachTagAsync($company_id, $plant_id, $tag_id)
    {
        return $this->detachTagAsyncWithHttpInfo($company_id, $plant_id, $tag_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function detachTagAsyncWithHttpInfo($company_id, $plant_id, $tag_id)
    {
        $returnType = 'string[]';
        $request = $this->detachTagRequest($company_id, $plant_id, $tag_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function detachTagRequest($company_id, $plant_id, $tag_id)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getPlantTags($company_id, $plant_id)
    {
        list($response) = $this->getPlantTagsWithHttpInfo($company_id, $plant_id);
        return $response;
    }
     ...
     */
    public function getPlantTagsWithHttpInfo($company_id, $plant_id)
    {
        $request = $this->getPlantTagsRequest($company_id, $plant_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPlantTagsAsync($company_id, $plant_id)
    {
        return $this->getPlantTagsAsyncWithHttpInfo($company_id, $plant_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPlantTagsAsyncWithHttpInfo($company_id, $plant_id)
    {
        $returnType = '\SunDataMetropolisClient\Model\Tag[]';
        $request = $this->getPlantTagsRequest($company_id, $plant_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPlantTagsRequest($company_id, $plant_id)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
