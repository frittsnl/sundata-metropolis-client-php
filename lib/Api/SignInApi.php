...
class SignInApi
{
     ...
     *
     * @param  \SunDataMetropolisClient\Model\Request $request request (optional)
     ...
     * @return \SunDataMetropolisClient\Model\Response
     */
    public function signIn($request = null, string $contentType = self::contentTypes['signIn'][0])
    {
        list($response) = $this->signInWithHttpInfo($request, $contentType);
        return $response;
    }
     ...
     * Obtain a bearer token and sign-in
     *
     * @param  \SunDataMetropolisClient\Model\Request $request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['signIn'] to see the possible values for this operation
     *
     * @throws \SunDataMetropolisClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SunDataMetropolisClient\Model\Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function signInWithHttpInfo($request = null, string $contentType = self::contentTypes['signIn'][0])
    {
        $request = $this->signInRequest($request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SunDataMetropolisClient\Model\Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SunDataMetropolisClient\Model\Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SunDataMetropolisClient\Model\Response', []),
            ...
            $returnType = '\SunDataMetropolisClient\Model\Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SunDataMetropolisClient\Model\Response',
     ...
     */
    public function signInAsync($request = null, string $contentType = self::contentTypes['signIn'][0])
    {
        return $this->signInAsyncWithHttpInfo($request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function signInAsyncWithHttpInfo($request = null, string $contentType = self::contentTypes['signIn'][0])
    {
        $returnType = '\SunDataMetropolisClient\Model\Response';
        $request = $this->signInRequest($request, $contentType);
     ...
     */
    public function signInRequest($request = null, string $contentType = self::contentTypes['signIn'][0])
    {



        $resourcePath = '/sign-in';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
