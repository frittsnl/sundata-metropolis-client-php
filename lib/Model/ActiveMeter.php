 ...
 */
class ActiveMeter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActiveMeter';
    ...
    protected static $openAPITypes = [
        ...
        'inbound_driver' => '\SunDataMetropolisClient\Model\InboundDriver'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['inbound_driver_id'] = $data['inbound_driver_id'] ?? null;
        ...
        $this->container['p90_in_kwh'] = $data['p90_in_kwh'] ?? null;
        $this->container['orientation_in_degrees'] = $data['orientation_in_degrees'] ?? null;
        $this->container['angle_in_degrees'] = $data['angle_in_degrees'] ?? null;
        $this->container['has_mixed_panel_orientations'] = $data['has_mixed_panel_orientations'] ?? null;
        $this->container['status'] = $data['status'] ?? null;
        $this->container['updated_at'] = $data['updated_at'] ?? null;
        $this->container['created_at'] = $data['created_at'] ?? null;
        $this->container['retired_on'] = $data['retired_on'] ?? null;
        ...
        $this->container['inbound_driver'] = $data['inbound_driver'] ?? null;
    }
    ...
    public function setOrientationInDegrees($orientation_in_degrees)
    {
        ...
        if (!is_null($orientation_in_degrees) && ($orientation_in_degrees > 359)) {
            throw new \InvalidArgumentException('invalid value for $orientation_in_degrees when calling ActiveMeter., must be smaller than or equal to 359.');
        }
        if (!is_null($orientation_in_degrees) && ($orientation_in_degrees < 0)) {
            throw new \InvalidArgumentException('invalid value for $orientation_in_degrees when calling ActiveMeter., must be bigger than or equal to 0.');
        }
    ...
    public function setAngleInDegrees($angle_in_degrees)
    {
        ...
        if (!is_null($angle_in_degrees) && ($angle_in_degrees > 360)) {
            throw new \InvalidArgumentException('invalid value for $angle_in_degrees when calling ActiveMeter., must be smaller than or equal to 360.');
        }
        if (!is_null($angle_in_degrees) && ($angle_in_degrees < 0)) {
            throw new \InvalidArgumentException('invalid value for $angle_in_degrees when calling ActiveMeter., must be bigger than or equal to 0.');
        }
     ...
     * Gets inbound_driver
     *
     * @return \SunDataMetropolisClient\Model\InboundDriver|null
     */
     ...
     * Sets inbound_driver
     *
     * @param \SunDataMetropolisClient\Model\InboundDriver|null $inbound_driver inbound_driver
     *
     * @return self
     */
