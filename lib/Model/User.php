...
class User implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'email' => false,
        'admin' => false,
        'subscribed_to_status_emails' => false,
        'updated_at' => false,
        'created_at' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('subscribed_to_status_emails', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($subscribed_to_status_emails)) {
            throw new \InvalidArgumentException('non-nullable subscribed_to_status_emails cannot be null');
        }
