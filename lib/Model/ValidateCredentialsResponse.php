...
/**
 * ValidateCredentialsResponse Class Doc Comment
 *
 * @category Class
 * @package  SunDataMetropolisClient
 * @author   OpenAPI Generator team
 ...
 */
class ValidateCredentialsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ValidateCredentialsResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('validates', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets unique
     *
     * @param bool|null $unique Are these credentials already registered with Sundata?
     *
     * @return self
     */
    ...
    {
        return $this->container['validates'];
    }

    /**
     * Sets validates
     *
     * @param bool|null $validates Is this reference identifier valid according to the 3rd parties API?
     *
     * @return self
     */
    public function setValidates($validates)
    {
        if (is_null($validates)) {
            throw new \InvalidArgumentException('non-nullable validates cannot be null');
        }
        $this->container['validates'] = $validates;
