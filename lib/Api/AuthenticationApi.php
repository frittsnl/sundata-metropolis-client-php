...
class AuthenticationApi
{
    ...
    {
        list($response) = $this->signInWithHttpInfo($email, $password);
        return $response;
    }
     ...
     */
    public function signInWithHttpInfo($email, $password)
    {
        $request = $this->signInRequest($email, $password);
     ...
     */
    public function signInAsync($email, $password)
    {
        return $this->signInAsyncWithHttpInfo($email, $password)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function signInAsyncWithHttpInfo($email, $password)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse200';
        $request = $this->signInRequest($email, $password);
     ...
     */
    protected function signInRequest($email, $password)
    {
        // verify the required parameter 'email' is set
        if ($email === null || (is_array($email) && count($email) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email when calling signIn'
            );
        }
